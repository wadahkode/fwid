    ...
    <div class="lg:w-1/4 md:w-2/4 w-full inline-flex flex-col gap-y-3 container mx-4">
      ...
      <form class="bg-white shadow-lg rounded-md lg:p-6 md:p-6 p-4 inline-flex flex-col gap-y-3" action="/admin/signin" method="post">
        ...
        <div class="inline-flex justify-between items-center">
          ...
          <div>
            <a href="admin/help/password" class="text-blue-600">Lupa kata sandi?</a>
          </div>
        </div>
        <div>
          <hr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/framework-id/src/Templates/admin/index.blade.php ENDPATH**/ ?>