...
<?php $__env->startSection('main'); ?>
  <main id="main" class="px-5 py-2">
    <div id="main-content" class="lg:grid lg:grid-cols-4 md:grid-cols-4 flex flex-col gap-4">
      <div class="bg-white shadow-lg rounded-lg p-4 flex items-center gap-2">
    ...
    <div id="visitor-content" class="lg:grid lg:grid-cols-3 flex flex-col gap-6 mt-4">
      ...
      <div>
        <div class="bg-white rounded-md shadow-md p-4 relative h-auto lg:mt-10">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/framework-id/src/Templates/admin/dashboard.blade.php ENDPATH**/ ?>